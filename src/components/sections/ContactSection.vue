  ...
  <section class="ap-section ap-contact" :aria-label="title || 'Contact'">
    ...
    <div class="ap-container ap-contact__split">
      ...
      <form class="ap-contact__form" :action="formAction" method="post">
        <div class="ap-field"><label for="ap-project-1">Project type</label>
          <select id="ap-project-1" name="project" class="ap-input">
            <option value="">— Select —</option><option>New build</option>
            <option>Renovation</option><option>Repair / service</option><option>General enquiry</option>
          </select>
        </div>
    ...
    <div class="ap-container ap-contact__brutalist">
      <header class="ap-contact__brutalist-head">
        ...
        <h2 class="ap-contact__brutalist-title">{{ title || 'Send—us—a—brief' }}</h2>
